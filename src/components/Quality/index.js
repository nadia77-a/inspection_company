        ...
        <div className="centerContent description">
          ...
          <div className="description__row">
            <div className="description__row__col2">
              <h3>
                <strong>INTERSICA Auditors</strong>
              </h3>
              <p>
                During the INTERSICA (formerly Socotec Oil&Gas) employment
                process all INTERSICA auditors are vetted verifying competencies
                ...
                INTERSICA’s standards while conducting your business, including
            ...
            <div className="description__row__col2">
              ...
              <p>
                INTERSICA (formerly Socotec Oil&Gas) personnel are dedicated to
                ...
                mandatory with all INTERSICA auditors to ensure sufficient
